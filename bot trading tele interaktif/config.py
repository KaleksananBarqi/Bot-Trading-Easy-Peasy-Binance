...
# Indikator EMA
EMA_FAST = 9          # Tetap (Momentum 15m)
EMA_SLOW = 21          # Tetap (Momentum 15m)
EMA_TREND_H1 = 200      # UBAH: Dari 200 jadi 50 (Biar lebih responsif ikut tren baru)
...
VOL_MULTIPLIER = 0.1   # UBAH: Cukup 1.0x (Sama dengan rata-rata aja sudah valid)
VOL_PERIOD = 20        

# ATR & Risk Management (TETAP AMAN)
ATR_PERIOD = 14
SL_MULTIPLIER = 2.0    # SL tetap 2x ATR (Jangan diubah biar akun aman)
TP_MULTIPLIER = 2.5    # TP tetap 3x ATR

# Setting Lain
LIQUIDITY_PERIOD = 5  # UBAH: Cek Low/High 10 candle terakhir (Sweep pendek diambil)
COOLDOWN_MINUTES = 5  # Istirahat setelah entry
